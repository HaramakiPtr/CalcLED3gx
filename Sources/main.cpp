...
{
	const std::string about = "Twitter @HaramakiPTR\n\n" \
		"<参考>\n" \
		"https://github.com/HIDE810/MultiFunc3gx/blob/master/Sources/calc.cpp\n\n" \
...
exit:
	...
	{
		menu += new MenuEntry("LEDフラッシュ", LedFlah, "DPadで点灯\nYを押しながら操作でスムージング");
		menu += new MenuEntry("Hex Calculator+", nullptr, Calculator);
	}

    int     main(void)
    {
		//securityLock("haramaki");
		
		PluginMenu *menu = new PluginMenu("ぷらぐいん", 0, 0, 0, about);
